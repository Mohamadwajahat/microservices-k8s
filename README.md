...
This project demonstrates a microservices-based REST API built with Flask and connected to MongoDB. The entire setup is containerized with Docker and orchestrated using Docker Compose for multi-container networking.
